...
import { ConfigDropDown } from "../../models/ConfigDropDown";
@Component({
...
export class NgxSelectDropdownComponent
   ...
   */
  @Input() public config: Partial<ConfigDropDown> = {};
   ...
   * Value
   */
  @Input() @Optional() public disabled: boolean = false;
  ...
  /**
   * Event emitted when dropdown is close.
   */
  @Output() public close: EventEmitter<any> = new EventEmitter();
     /**
   * Event emitted when dropdown is add new item.
   */
